...
var builderSelector = require('./builders/selector');
var packageBuilderClass = require('./builders/packageBuilder');
...
var addNewDependencies = function(names, q, builders) {
    ...
    _.each(unknown, function(name){
        ...
        var newBuilder = new packageBuilderClass(name, settings);
...
module.exports = 
{
    make: function (settings, finalCallback) {    
        ...
        dependencyQueue.drain = function(){
            ...
            builders = dependencySorter.sort(
                builders, 
